...
public class Podometro {
    ...
    int horaFin) {
        switch(dia){
           ...
           System.out.println("Distancia recorrida finde semana:" + totalDistanciaFinSemana + "Km");
           ...
           System.out.println(" Nº caminatas realizada a partir de las 21h.: " + caminatasNoche);
           System.out.println(" Total tiempo caminado en la semana " + (tiempo / 60) + "h y" + (tiempo % 60) + "m");
            }
